        ...
        <View style={{ flex: 1, justifyContent: "center", backgroundColor:"#1B2430"}}>
            <View style={{ backgroundColor: "#F0EBE3", borderTopRightRadius: 20, borderTopLeftRadius: 20, padding: 20 }}>
                ...
                <View style={{ alignItems: "center" }}>
                    <TouchableOpacity
                        style={{ backgroundColor: "#1B2430", width: "40%", justifyContent: "center", alignItems: "center", paddingVertical: 10, borderRadius: 10,color:"#1B2430" }}
                        onPress={() => { navigation.navigate("home") }}>
                        <Text style={{ fontSize: 20, fontWeight: "bold",color:"#F0EBE3" }}>Login</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={{}}
                        onPress={() => { navigation.navigate("signUp") }}>
                        <Text style={{color:"#1B2430"}}>Don't have an account? <Text style={{ color: "blue", fontWeight: "bold",color:"#1B2430" }}>Sign Up</Text></Text>
                    </TouchableOpacity>
                </View>
            </View >
        </View >
